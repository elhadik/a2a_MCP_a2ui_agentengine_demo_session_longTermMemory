...
5. The tool returns the sizing metrics and the Sizing Dashboard <a2ui-json> XML block. You MUST copy and print this block exactly as-is verbatim to render the activation dashboard.
